                                             ...
                                             uint64_t aInputBlockId)
{
  if (NS_GetCurrentThread() != mUIThread) {
    ...
    // thread).
    mUIThread->Dispatch(NewRunnableMethod<const LayoutDevicePoint, Modifiers, const ScrollableLayerGuid, uint64_t>("mozilla::embedlite::EmbedContentController::HandleDoubleTap",
                                                                                                                 this,
                                             ...
                                             uint64_t aInputBlockId)
{
  if (NS_GetCurrentThread() != mUIThread) {
    // We have to send this message from the "UI thread" (main
    // thread).
    mUIThread->Dispatch(NewRunnableMethod<const LayoutDevicePoint, Modifiers, const ScrollableLayerGuid, uint64_t>("mozilla::embedlite::EmbedContentController::HandleSingleTap",
                                                                                                                 this,
